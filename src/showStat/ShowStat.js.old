    ...
    const getData = async () => {
      ...
      actionTypeSummaryRow = (
        <tr>
          ...
          <td>{result.actionTypeSummary.P}</td>
          <td>{result.actionTypeSummary.R}</td>
          <td>
            {Number(
              result.actionTypeSummary.P / result.actionTypeSummary.R
            ).toFixed(2) + ":1"}
          </td>
        </tr>
      );
      ...
      for (
        let i = 0;
        i < result.a1SystemServicePerformanceSummary.length;
        i++
      ) {
        a1SystemServicePerformanceSummary.push(
          <tr key={"a1SystemServicePerformanceSummary_" + i}>
            ...
            <td>0</td>
            <td>{result.a1SystemServicePerformanceSummary[i].H}</td>
            <td>{result.a1SystemServicePerformanceSummary[i].H_PRE}</td>
            <td>{result.a1SystemServicePerformanceSummary[i].S}</td>
            <td>0</td>
            <td>{result.a1SystemServicePerformanceSummary[i].S}</td>
            <td>{result.a1SystemServicePerformanceSummary[i].S_PRE}</td>
            <td>{result.a1SystemServicePerformanceSummary[i].P}</td>
            <td>0</td>
            <td>{result.a1SystemServicePerformanceSummary[i].P}</td>
            <td>{result.a1SystemServicePerformanceSummary[i].P_PRE}</td>
            <td>0/0</td>
            <td>0/0</td>
          </tr>
        );
        sum.H += result.a1SystemServicePerformanceSummary[i].H;
        sum.H_PRE += result.a1SystemServicePerformanceSummary[i].H_PRE;
        sum.S += result.a1SystemServicePerformanceSummary[i].S;
        sum.S_PRE += result.a1SystemServicePerformanceSummary[i].S_PRE;
        sum.P += result.a1SystemServicePerformanceSummary[i].P;
        sum.P_PRE += result.a1SystemServicePerformanceSummary[i].P_PRE;
      }
      a1SystemServicePerformanceSummary.push(
        <tr
          key={
            "a1SystemServicePerformanceSummary_" +
            result.a1SystemServicePerformanceSummary.length
          }
        >
          <td>Total</td>
          <td>{sum.H}</td>
      ...
      for (
        let i = 0;
        i < result.nonA1SystemServicePerformanceSummary.length;
        i++
      ) {
        nonA1SystemServicePerformanceSummary.push(
          <tr key={"nonA1SystemServicePerformanceSummary_" + i}>
            <td>
              {result.nonA1SystemServicePerformanceSummary[i].system_name}
            </td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].H}</td>
            <td>0</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].H}</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].H_PRE}</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].S}</td>
            <td>0</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].S}</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].S_PRE}</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].P}</td>
            <td>0</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].P}</td>
            <td>{result.nonA1SystemServicePerformanceSummary[i].P_PRE}</td>
            <td>0/0</td>
            <td>0/0</td>
          </tr>
        );
        sum.H += result.nonA1SystemServicePerformanceSummary[i].H;
        sum.H_PRE += result.nonA1SystemServicePerformanceSummary[i].H_PRE;
        sum.S += result.nonA1SystemServicePerformanceSummary[i].S;
        sum.S_PRE += result.nonA1SystemServicePerformanceSummary[i].S_PRE;
        sum.P += result.nonA1SystemServicePerformanceSummary[i].P;
        sum.P_PRE += result.nonA1SystemServicePerformanceSummary[i].P_PRE;
      }
      nonA1SystemServicePerformanceSummary.push(
        <tr key={"nonA1SystemServicePerformanceSummary_" + result.nonA1SystemServicePerformanceSummary.length}>
          <td>Total</td>
          <td>{sum.H}</td>
          <td>0</td>
          <td>{sum.H}</td>
      ...
      isSolvedByCOSSSummaryRow = (
        <tr>
          ...
          <td>
            {result.isSolvedByCOSSSummary.total -
              result.isSolvedByCOSSSummary.in_office_hour}
          </td>
      ...
      setDataRow({
        ...
        nonA1SystemServicePerformanceSummary:
          nonA1SystemServicePerformanceSummary,
    ...
    <div>
      ...
      <div className="p-1">
        ...
        <table border="1">
          ...
          <tbody>{dataRow.nonA1SystemServicePerformanceSummary}</tbody>
        </table>
        <br />
        <table border="1">
          <thead>
          ...
          <tbody>{dataRow.a1SystemServicePerformanceSummary}</tbody>
        </table>
        <br />
        <table border="1">
          <thead>
